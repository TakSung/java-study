#!/usr/bin/env python3
"""
Platform Setup Script for Python & Java Katas
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Setup platform-specific files for Python & Java Katas",
...
Note: This script configures Python environments (venv/conda).
      For Java projects, ensure Maven and Java 21 are installed separately.
        """
    )
    parser.add_argument(
        "platform",
    ...
    try:
        ...
        print("=" * 60)
        print()
        print(f"Your Python environment is now configured for {platform_name.upper()} with {env_type.upper()}.")
        print()
        print("Next steps:")
        ...
        print()
        print("Java projects:")
        print("  - Ensure Java 21 and Maven are installed")
        print("  - See docs/resource/java-apcs-project-structure.md")
        print()
